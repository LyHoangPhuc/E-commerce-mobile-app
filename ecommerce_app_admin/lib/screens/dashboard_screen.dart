import 'package:ecommerce_app_admin/widgets/dashboard_btn_widget.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'package:ecommerce_app_admin/widgets/title_text.dart';
...
class DashboardScreenState extends State<DashboardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const TitlesTextWidget(label: "Bảng điều khiển"),
        leading: Padding(
