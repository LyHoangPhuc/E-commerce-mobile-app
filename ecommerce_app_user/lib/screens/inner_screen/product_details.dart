...
import 'package:ecommerce_app_user/widgets/products/heart_btn.dart';
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            SubtitleTextWidget(
                              label:
                                  "${MyAppFunctions.formatPrice(double.parse(getCurrProduct.productPrice))}VND",
                              fontSize: 20,
                        ...
                        Row(
                          ...
                          children: [
                            const TitlesTextWidget(label: "Chi tiết sản phẩm"),
                            SubtitleTextWidget(
                                label:
                                    "Danh mục ${getCurrProduct.productCategory}"),
                          ],
                        ),
                        const SizedBox(
                          height: 15,
