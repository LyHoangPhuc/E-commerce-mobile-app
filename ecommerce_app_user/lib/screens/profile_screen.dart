...
import 'package:ecommerce_app_user/screens/auth/login.dart';
            ...
            children: [
              Visibility(
                ...
                child: const Padding(
                  ...
                  child: TitlesTextWidget(
                    label: "Vui lòng đăng nhập để có quyền truy cập",
                  ),
                ),
              ),
              userModel == null
                        ...
                        if (user == null) {
                          showDialog(
                            ...
                            builder: (context) => AlertDialog(
                              ...
                              content: const Text(
                                  'Vui lòng đăng nhập để truy cập địa chỉ'),
                              actions: [
                                TextButton(
              ...
              Center(
                child: ElevatedButton.icon(
                  ...
                  label: Text(user == null ? "Đăng nhập" : "Đăng xuất"),
                  onPressed: () async {
                    if (user == null) {
