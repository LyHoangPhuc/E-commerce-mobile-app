...
import 'package:ecommerce_app_user/consts/app_constants.dart';
import 'package:ecommerce_app_user/widgets/products/ctg_rounded_widget.dart';
import 'package:ecommerce_app_user/widgets/products/latest_arrival.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              Visibility(
                ...
                child: const TitlesTextWidget(label: "Hàng mới nhất"),
              ),
              const SizedBox(
                height: 15.0,
              ),
